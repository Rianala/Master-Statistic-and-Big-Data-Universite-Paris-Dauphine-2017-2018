...
def doKMeans(data, clusters=0):
  ...
  model.fit(data)
  KMeans(copy_x=True, init='k-means++', max_iter=300, n_clusters=clusters, n_init=10,n_jobs=1, precompute_distances='auto', random_state=None, tol=0.0001,verbose=0)
...
ax.scatter(df.Grocery, df.Fresh, marker='.', alpha=0.3)  
print (centroids)
